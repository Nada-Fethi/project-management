...
const ProjectOverview = () => {
  ...
  return (
    currentWorkspace && (
      <div className="bg-purple-100/99 dark:bg-zinc-800 dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-200 rounded-lg overflow-hidden">
        <div className="border-b border-zinc-200 dark:border-zinc-800 p-4 flex items-center justify-between">
          <h2 className="text-md text-zinc-900 dark:text-zinc-300">
            Project Overview
          </h2>
          <Link
            to={"/projects"}
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-zinc-800 dark:text-zinc-400 line-clamp-2">
                  ...
                  <div className="flex items-center justify-between text-xs text-zinc-600 dark:text-zinc-300/99 mb-3">
