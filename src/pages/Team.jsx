    ...
    <div className="space-y-6 max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div className="flex flex-wrap gap-4">
        {[
          ...
          <div
            key={i}
            className="max-sm:w-full dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-gray-300 dark:border-zinc-800 rounded-lg p-6 flex-1"
          >
      ...
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="pl-8 w-full text-sm rounded-md border border-gray-300 dark:border-zinc-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-400 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition"
        />
      </div>
